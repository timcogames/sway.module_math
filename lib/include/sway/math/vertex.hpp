...
struct VertexPosition {
   ...
   */
  vec3f_t getPosition() const { return TVector3<f32_t>(x, y, z); }
};
...
struct VertexColor : public VertexPosition {
   ...
   */
  col4f_t getColor() const { return TColor<f32_t>(r, g, b, a); }
};
...
struct VertexTexCoord : public VertexPosition {
   ...
   */
  vec2f_t getTexCoord() const { return TVector2<f32_t>(u, v); }
};
